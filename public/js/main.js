$(function () {
    ...
    $(".header-main li.ho").each(function () {
        if ($(this).hasClass("on")) {
            index = $(this).index();
            dd.stop(true, true).css({"left": ( index * (70 + 34) + 19 ) + "px"})
        }
        ;
    })
    $(".header-main li.ho").hover(function () {
        if ($(this).index() == 6) {
            index = $(this).index();
            dd.stop(true, true).animate({"left": ( index * (70 + 34) + 19 ) + "px"})
        }
        else {
...
function setNavPos() {
    var dd = $(".header-main .menub b");
    var id = request('id');
    var a = [[337,338,339,340,341,342],[346,347,348,349,350,351],[352,353,354,374],[355,356,357,358],[364,365,377],[359,360,361],[336]];
    var index = 0;
    for(var i in a){
        for(var j in a[i]){
            if(a[i][j] == id){
...
function index() {
    ...
    $(".cpxl").hover(function () {
        ...
        $(".cpxlb").css("background", "url(" + $(".cpxlb").attr("rel") + ".jpg) no-repeat center");
        /*$(this).find(".tit").css("display","none");
         $(this).find(".entit").css("display","none");
         $(this).find('a').css("display","none");*/
    }, function () {
        $(this).find(".tit").stop().animate({"paddingTop": "120px"}, 800)
        /* $(this).find(".entit").stop().animate({"marginTop": "9px"},800)
         $(".i-fib .le ul").stop().animate({"opacity":"1","left":"-500px"},600)*/
        $(".cpxlb").css("background", "url(" + $(".cpxlb").attr("rel") + "-a.jpg) no-repeat center");
        /*$(this).find(".tit").css("display","block");
         $(this).find(".entit").css("display","block");
...
function coursescroll() {
    var hei = $(window).scrollTop();
    if (hei > $(".pr1").offset().top - 800) {
        $(".pr1").stop().animate({"opacity": "1", "margin-right": "0px"}, 600)
    }

    if (hei > $(".pl1").offset().top - 800) {
        $(".pl1").stop().animate({"opacity": "1", "margin-left": "0px"}, 600)
    }

    if (hei > $(".pr2").offset().top - 800) {
        $(".pr2").stop().animate({"opacity": "1", "margin-right": "0px"}, 600)
    }
    if (hei > $(".pl2").offset().top - 800) {
        $(".pl2").stop().animate({"opacity": "1", "margin-left": "0px"}, 600)
    }
    if (hei > $(".pr3").offset().top - 800) {
        $(".pr3").stop().animate({"opacity": "1", "margin-right": "0px"}, 600)
    }

    if (hei > $(".pl3").offset().top - 800) {
        $(".pl3").stop().animate({"opacity": "1", "margin-left": "0px"}, 600)
    }
    if (hei > $(".pr4").offset().top - 800) {
        $(".pr4").stop().animate({"opacity": "1", "margin-right": "0px"}, 600)
    }
    ...
    if (hei > $(".pr5").offset().top - 800) {
        $(".pr5").stop().animate({"opacity": "1", "margin-right": "0px"}, 600)
    }
    if (hei > $(".pl4").offset().top - 800) {
        $(".pl4").stop().animate({"opacity": "1", "margin-left": "0px"}, 600)
    }
    if (hei > $(".pr6").offset().top - 800) {
        $(".pr6").stop().animate({"opacity": "1", "margin-right": "0px"}, 600)
    }

    if (hei > $(".pl5").offset().top - 800) {
        $(".pl5").stop().animate({"opacity": "1", "margin-left": "0px"}, 600)
    }
    if (hei > $(".pr7").offset().top - 800) {
        $(".pr7").stop().animate({"opacity": "1", "margin-right": "0px"}, 600)
    }
    if (hei > $(".pl6").offset().top - 800) {
        $(".pl6").stop().animate({"opacity": "1", "margin-left": "0px"}, 600)
    }
    if (hei > $(".pr8").offset().top - 800) {
        $(".pr8").stop().animate({"opacity": "1", "margin-right": "0px"}, 600)
    }
    if (hei > $(".pr9").offset().top - 800) {
        $(".pr9").stop().animate({"opacity": "1", "margin-right": "0px"}, 600)
    }

    if (hei > $(".pl7").offset().top - 800) {
        $(".pl7").stop().animate({"opacity": "1", "margin-left": "0px"}, 600)
    }
...
function honor() {
    ...
    if (hei > 925) {
        ...
        setTimeout(function () {
            $(".tal-th .li").eq(3).animate({"opacity": "1", "margin-right": "92px"}, 800)
        }, 400)
...
function jmlc() {
    ...
    var animateList = [
        function () {
            li.eq(0).find("a").delay(100).animate({"opacity": 1, "marginLeft": "0px"}, 300, queueList);
        },
        function () {
            li.eq(1).find("a").delay(100).animate({"opacity": 1, "marginLeft": "0px"}, 300, queueList);
        },
        function () {
            li.eq(2).find("a").delay(100).animate({"opacity": 1, "marginLeft": "0px"}, 300, queueList);
        },
        function () {
            li.eq(3).find("a").delay(100).animate({"opacity": 1, "marginLeft": "0px"}, 300, queueList);
        },
        function () {
            li.eq(4).find("a").delay(100).animate({"opacity": 1, "marginLeft": "0px"}, 300, queueList);
        },
        function () {
            li.eq(5).find("a").delay(100).animate({"opacity": 1, "marginTop": "0px"}, 300, queueList);
        },
        function () {
            li.eq(6).find("a").delay(100).animate({"opacity": 1, "marginLeft": "0px"}, 300, queueList);
        },
        function () {
            li.eq(7).find("a").delay(100).animate({"opacity": 1, "marginLeft": "0px"}, 300, queueList);
        },
        function () {
            li.eq(8).find("a").delay(100).animate({"opacity": 1, "marginLeft": "0px"}, 300);
        }
    ];
